...
const generateToken = (email) => __awaiter(void 0, void 0, void 0, function* () {
    const jwt = (0, jsonwebtoken_1.sign)({ email }, JWT_SECRET, { expiresIn: "1h" });
    return jwt;
});
exports.generateToken = generateToken;
const verifiedToken = (jwt) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const isVerified = yield (0, jsonwebtoken_1.verify)(jwt, JWT_SECRET);
        return isVerified;
    }
    catch (error) {
